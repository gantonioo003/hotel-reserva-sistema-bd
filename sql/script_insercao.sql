...
VALUES ('João Silva', '12345678900', '1990-05-10', 'Rua A', '100', 'Rio de Janeiro', 'RJ', '20000000');

INSERT INTO Pessoa (nome, cpf, data_nascimento, rua, numero, cidade, estado, cep)
VALUES ('Ana Souza', '98765432100', '1985-03-22', 'Rua B', '200', 'São Paulo', 'SP', '01000000');

-- Telefones
INSERT INTO Telefone (id_pessoa, numero) VALUES (1, '(21)91234-5678');
INSERT INTO Telefone (id_pessoa, numero) VALUES (1, '(21)97654-3210');
INSERT INTO Telefone (id_pessoa, numero) VALUES (2, '(11)99876-1234');
...
VALUES ('101', 'simples', 1, 150.00, 'livre');

INSERT INTO Quarto (numero, tipo, capacidade, valor_diaria, status)
VALUES ('102', 'suíte', 2, 300.00, 'livre');

-- Reserva
INSERT INTO Reserva (id_hospede, data_entrada, data_saida, qtd_hospedes)
VALUES (1, '2024-04-01', '2024-04-05', 1);

-- Ligando reserva ao quarto
INSERT INTO Reserva_Quarto (id_reserva, id_quarto) VALUES (1, 1);

-- Serviços
INSERT INTO Servico (nome, descricao, preco)
VALUES ('Café da manhã', 'Buffet completo', 30.00);

-- Ligando reserva ao serviço
INSERT INTO Reserva_Servico (id_reserva, id_servico) VALUES (1, 1);
